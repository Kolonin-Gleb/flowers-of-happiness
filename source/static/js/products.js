// Здесь должен находиться код, который позволит
// отправлять запросы на сервер и получать ответы.
// Для этого используется технология Ajax запросов.
// JavaScript будет барть данные из результатов Ajax запросов 
// и отображать их на фронтенде
